...
const testimonials = [
  {
    id: 1,
    text: "Working with Sandy was an absolute pleasure. Her exceptional talent in UI/UX design shines through in every aspect of our project. Not only did she elevate our online presence, but she also demonstrated a deep understanding of user needs, resulting in intuitive and visually stunning interfaces.",
  ...
  {
    id: 2,
    text: "The attention to detail and creative solutions exceeded our expectations. The design process was smooth and collaborative, resulting in a product that truly represents our brand vision.",
    author: "James Miller",
    role: "CEO, TechStart",
    image: testimonialImage,
  },
